...
public class AccountServiceImpl implements AccountService {
	...
	public void deposit(String accountType, BigDecimal amount, Principal principal) {
        AmountUtil.requirePositive(amount);
    ...
    public void withdraw(String accountType, BigDecimal amount, Principal principal) {
        ...
        if (accountType.equalsIgnoreCase("Primary")) {
            PrimaryAccount primaryAccount = user.getPrimaryAccount();
            AmountUtil.requireSufficientFunds(primaryAccount.getAccountBalance(), amount);
            ...
            SavingsAccount savingsAccount = user.getSavingsAccount();
            AmountUtil.requireSufficientFunds(savingsAccount.getAccountBalance(), amount);
